(() => {
  ...
  const commonRules = [
    ...
    [/thứ tự byte/giu, "Endianness"],
    [/little-endian/giu, "Little-Endian"],
    [/big-endian/giu, "Big-Endian"],
    [/(?<![\p{L}\p{N}_-])endian(?![\p{L}\p{N}_])/giu, "Endianness"],
  ...
  const softwareRules = [
    ...
    [/hệ điều hành/giu, "OS"],
    [/mô hình nguyên khối/giu, "Monolithic Kernel"],
    [/nhân OS nguyên khối/giu, "Monolithic Kernel"],
    [/OS nguyên khối/giu, "Monolithic Kernel"],
    [/mô hình vi nhân/giu, "Microkernel"],
    [/mô hình phân lớp/giu, "Layered OS"],
    [/OS phân lớp/giu, "Layered OS"],
    [/nhân nguyên khối/giu, "Monolithic Kernel"],
    [/vi nhân/giu, "Microkernel"],
    [/vào cùng một khối nhân OS lớn nhất có thể/giu, "vào Kernel"],
    [/khối nhân OS/giu, "Kernel"],
    [/nhân OS/giu, "Kernel"],
    [/ra ngoài nhân/giu, "ra ngoài Kernel"],
    [/ngoài nhân/giu, "ngoài Kernel"],
  ...
  const bootloaderRules = [
    ...
    [/ngân hàng/giu, "Bank"],
    [/hai Physical Flash Bank/giu, "Dual Bank"],
    [/hai Physical Bank/giu, "Dual Bank"],
    [/một Physical Flash Bank/giu, "Single Bank"],
    [/Phần cứng hai Bank độc lập/gu, "Kiến trúc Dual Bank"],
    [/phần cứng hai Bank độc lập/gu, "kiến trúc Dual Bank"],
    [/hai Bank độc lập/giu, "Dual Bank"],
    [/Flash hai Bank/giu, "Dual-Bank Flash"],
    [/hai Bank/giu, "Dual Bank"],
    [/một Flash đơn/giu, "Single-Bank Flash"],
    [/Flash một Bank/giu, "Single-Bank Flash"],
    [/Flash đơn/giu, "Single-Bank Flash"],
    [/cùng Physical Bank/giu, "cùng một Flash Bank"],
    [/Dual Bank độc lập/giu, "Dual Bank"],
    [/Phần cứng Dual Bank/gu, "Kiến trúc Dual Bank"],
    [/phần cứng Dual Bank/gu, "kiến trúc Dual Bank"],
    [/Physical Bank là cấu trúc phần cứng/giu, "Dual Bank là kiến trúc phần cứng"],
